...
def plot_dataset(lengths, database_name, criteria, optima, floorstruc, requirements, crsec_type, mat_names,
    ...
    for mat_name in mat_names:
        if crsec_type == "tcc":
            ...
            section_low = struct_analysis.TCC(concrete_low, rebar_low, timber_low, connector, 0.2, 0.625, 0.08, 0.12, 0.18, 0.015, 2)
            section_high = struct_analysis.TCC(concrete_high, rebar_high, timber_high, connector, 0.2, 0.625, 0.08, 0.12, 0.18, 0.015, 2)
