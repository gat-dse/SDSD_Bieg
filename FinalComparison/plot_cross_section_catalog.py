...
CATALOG = [
    {
        ...
        "optimized": [
            ...
            "$\\varnothing_w$: shear rebar, $0$ to $16\\,\\mathrm{mm}$ (fixed to $0$ for office columns)",
        ],
    ...
    },
    {
        ...
        "optimized": [
            "$h_w$: rib height, $0.05$ to $1.20\\,\\mathrm{m}$",
            "$h_f$: flange thickness, $0.12$ to $0.40\\,\\mathrm{m}$",
            "$b_w$: rib width, $0.15$ to $0.40\\,\\mathrm{m}$",
            "$b$: effective width, $0.40$ to $2.50\\,\\mathrm{m}$",
            "$\\varnothing_{x,w}$: rib rebar, $8$ to $40\\,\\mathrm{mm}$",
            "$\\varnothing_{x,o}$: upper support rebar, $8$ to $40\\,\\mathrm{mm}$",
        ],
    ...
    },
    {
        ...
        "optimized": [
            "$b$: rib width, $0.10$ to $0.28\\,\\mathrm{m}$",
            "$h$: rib height, $0.40$ to $0.80\\,\\mathrm{m}$",
