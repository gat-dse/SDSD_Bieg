\begin{table*}[t]
    ...
    Residential & 2.0 & 3, 5, 6, 7, 8, 10 &
    TCC &
    ribs, connection ``DBS\_10'', $s=0.06$\,m &
    Simple span &
    ...
    conventionally reinforced &
    Continuous beam &
    ready-mixed concrete, B500B; start $b_w=0.25$\,m; fire from bottom and sides \\

    Office & 3.0 & 8, 10, 12, 16 &
    TCC &
    ribs, connection ``DBS\_10'', $s=0.04$\,m &
    Simple span &
...
\begin{table*}[t]
    ...
    $h=0.16$--$1.20$\,m, $\varnothing_{xu/xo}=6$--$40$\,mm, $\varnothing_w=0$--$16$\,mm; $s_w=0.15$\,m, $n_w=6$ if shear reinforcement is active; y-reinforcement follows x-reinforcement \\

    Rectangular concrete PT 2D &
    $b=1.00$\,m, $h=0.20$\,m generally; office start heights $h_0=\{0.20,0.25,0.30,0.40\}$\,m for $l=\{8,10,12,16\}$\,m &
    $h$, $\varnothing_{xu}$, $\varnothing_{xo}$, $\varnothing_w$ &
    $h=0.18$--$1.20$\,m, $\varnothing_{xu/xo}=6$--$40$\,mm, $\varnothing_w=0$--$16$\,mm; $s_w=0.15$\,m, $n_w=6$ if shear reinforcement is active; Y1860 monostrands; load balancing from PT layout \\
    ...
    Ribbed concrete 1D &
    $b=1.00$\,m, $b_w=0.15$\,m generally; office start $b_w=0.25$\,m; $h=0.30$\,m, $h_f=0.18$\,m &
    ...
    $h_c$, $h_w$ &
    $h_c=0.08$--$0.50$\,m, $h_w=0.08$--$1.50$\,m; flat residential $s=0.50$\,m; ribbed residential $s=0.06$\,m, $b_w=0.18$\,m; ribbed office $s=0.04$\,m, $b_w=0.24$\,m \\ \hline
    \end{tabularx}
    \endgroup
